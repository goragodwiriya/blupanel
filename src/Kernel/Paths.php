...
final class Paths
{
     ...
     *
     * ตั้งแต่ migration 0006 ไฟล์เว็บไม่ได้อยู่ที่ `<sites.dir>/<domain>` อีกแล้ว แต่อยู่ที่
     * `<users.dir>/<username>/domains/<domain>` เพราะ uid และโควตาดิสก์ผูกกับผู้ใช้
     * ไม่ใช่ผูกกับเว็บ · `sitesDir()` ยังอยู่เพื่ออ่านไฟล์ของเลย์เอาต์เดิมที่ยังไม่ได้ย้าย
     */
    public const DEFAULT_USERS_DIR = '/srv/phpcp/users';
