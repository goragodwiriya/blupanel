...
| PHP | เห็นทุกเวอร์ชันที่ apt ของเครื่องนี้มี · ติดตั้ง/ถอดถอนได้จากหน้าเว็บ (งานเบื้องหลังผ่าน systemd) · สถานะการรองรับตัดสินจากวันหมดอายุที่ php.net ประกาศ จึงไม่ต้องแก้โค้ดเมื่อมีเวอร์ชันใหม่ |
