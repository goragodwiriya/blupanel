    ...
    #
    # ยกเว้น `.well-known` — ACME HTTP-01 ดาวน์โหลดไฟล์จากใต้เส้นทางนั้น ถ้าปฏิเสธด้วย
    # ขอใบรับรองจะล้มทุกครั้งโดยที่ข้อความผิดพลาดไม่ได้ชี้มาที่กฎนี้เลย · ดูคำอธิบายเต็ม
    # ใน proxy-static.conf.tpl
    location ~ /\.(?!well-known/) {
        deny all;
    }
