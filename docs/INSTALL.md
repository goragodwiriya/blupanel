...
หน้าจัดการอ่านใบรับรองจาก `/etc/phpcp/tls/panel.crt` เสมอ · **ยังไม่มีปุ่มในหน้าเว็บสำหรับ
เปลี่ยนใบรับรองของตัวหน้าจัดการเอง** (หน้า SSL Certificates จัดการใบของ*เว็บไซต์* ไม่ใช่ของ
หน้าจัดการ) · เปลี่ยนเป็นใบจริงได้ด้วยการ symlink ไปที่ใบของ Let's Encrypt แล้วรีสตาร์ต
`phpcp-web` — ขั้นตอนเต็มพร้อม hook ต่ออายุอยู่ใน
[INSTALL-LIGHTSAIL.md ข้อ 9.2](INSTALL-LIGHTSAIL.md#92-ให้หน้าจัดการใช้ใบนั้น--ต้องทำด้วยมือ)
